...
final class MSPAgentConversationCompactionRequestTests: MSPAgentConversationRequestTestCase {
    ...
    func testManualLocalCompactContextWindowExceededWhenNoCompactInputRemainsFailsFull() async throws {
        ...
        XCTAssertEqual(fullUsage.contextWindowTokens, 272_000)
        XCTAssertEqual(fullUsage.effectiveContextWindowTokens, 258_400)
        XCTAssertEqual(fullUsage.currentTokens, fullUsage.effectiveContextWindowTokens)
        XCTAssertEqual(fullUsage.estimatedInputTokens, fullUsage.effectiveContextWindowTokens)
        XCTAssertEqual(fullUsage.currentWindowFraction, 1.0)
