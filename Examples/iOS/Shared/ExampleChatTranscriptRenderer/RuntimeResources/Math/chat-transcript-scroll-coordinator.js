  ...
  window.ChatTranscriptScrollCoordinatorFactory = function createChatTranscriptScrollCoordinator(dependencies) {
    ...
    function normalizedRenderOptions(followBottomOrOptions) {
      ...
      return {
        ...
        preserveScrollAnchor: options.preserveScrollAnchor !== false,
    ...
    function performConversationMutationPreservingScroll(options, mutation) {
      ...
      const shouldPreserveScrollAnchor = options.preserveScrollAnchor !== false;
      ...
      const anchor = shouldPreserveScrollAnchor && !shouldDeferLiveRender ? capturePresentationAnchor() : null;
      ...
      const shouldFollowBottom = shouldPreserveScrollAnchor && Boolean(options.followBottomIfNearBottom) && (
      ...
      } else if (shouldPreserveScrollAnchor && shouldPinTop && nextRoot) {
