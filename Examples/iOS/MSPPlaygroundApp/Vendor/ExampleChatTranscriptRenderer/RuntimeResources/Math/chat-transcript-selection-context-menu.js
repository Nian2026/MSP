(function() {
  ...
  var selectedTextOverlayStyleID = 'chat-transcript-selected-text-overlay-style';
  ...
  function ensureSelectedTextOverlayStyle() {
    ...
    style.textContent = [
      '.chat-transcript-selected-text-overlay{position:absolute;z-index:2147483646;display:flex;align-items:center;gap:3px;padding:2px 4px;border:1px solid rgba(0,0,0,.08);border-radius:999px;background:rgba(255,255,255,.98);box-shadow:0 8px 24px rgba(0,0,0,.14),0 1px 2px rgba(0,0,0,.08);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);font-family:-apple-system,BlinkMacSystemFont,"SF Pro Text","Helvetica Neue",Arial,sans-serif;user-select:none;-webkit-user-select:none;}',
      '.chat-transcript-selected-text-overlay button{appearance:none;-webkit-appearance:none;border:0;background:transparent;color:rgba(0,0,0,.94);border-radius:999px;height:28px;padding:0 7px;display:flex;align-items:center;gap:4px;font:400 14px/1.05 -apple-system,BlinkMacSystemFont,"SF Pro Text","Helvetica Neue",Arial,sans-serif;white-space:nowrap;cursor:default;}',
      '.chat-transcript-selected-text-overlay button:hover{background:rgba(0,0,0,.06);}',
      '.chat-transcript-selected-text-overlay .chat-transcript-selected-text-overlay-icon{width:14px;height:14px;display:block;flex:0 0 auto;background:currentColor;-webkit-mask:var(--selected-text-overlay-symbol) center/contain no-repeat;mask:var(--selected-text-overlay-symbol) center/contain no-repeat;}',
      '.chat-transcript-selected-text-overlay .chat-transcript-selected-text-overlay-icon-ask{transform:translateY(1px);}',
      ':root[data-theme="dark"] .chat-transcript-selected-text-overlay{border-color:rgba(255,255,255,.14);background:rgba(36,36,38,.96);box-shadow:0 8px 24px rgba(0,0,0,.34),0 1px 2px rgba(0,0,0,.26);}',
      ':root[data-theme="dark"] .chat-transcript-selected-text-overlay button{color:rgba(255,255,255,.90);}',
      ':root[data-theme="dark"] .chat-transcript-selected-text-overlay button:hover{background:rgba(255,255,255,.10);}'
    ].join('');
    (document.head || document.documentElement).appendChild(style);
  }
  ...
  function selectedTextOverlayIconElement(kind) {
    ...
    icon.className = 'chat-transcript-selected-text-overlay-icon chat-transcript-selected-text-overlay-icon-' + kind;
  ...
  function makeSelectedTextOverlayButton(kind, label, actionType) {
    ...
    labelElement.className = 'chat-transcript-selected-text-overlay-label';
  ...
  function ensureSelectedTextOverlayElement() {
    ...
    selectedTextOverlayElement.className = 'chat-transcript-selected-text-overlay';
